...
import app.controlers.ImpVisualiza;
...
public class FrameDetalheAll extends JFrame {
	...
	ImpVisualiza actionVisualizarArq = new ImpVisualiza();
	...
	public FrameDetalheAll() {
		...
		final ImageIcon tcr2 = new ImageIcon("src/imgs/lupa.gif");
		...
		tabela.addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent me) {
				if (me.getClickCount() == 1 && tabela.getSelectedColumn() == 0) {
					actionVisualizarArq.Visualizar(tabela.getSelectedRow());
					/*JOptionPane.showMessageDialog(null,
							new DadosArquivo().getValoresAll()[0][0] +"\n"
									+ new DadosArquivo().getValoresAll()[0][7],
							"Mês Selecionado", JOptionPane.YES_NO_OPTION, tcr2);*/
				}
				if (me.getClickCount() == 1 && tabela.getSelectedColumn() == 1) {
					JOptionPane
							.showConfirmDialog(
									null,
									"Reenviaremos o email deste mês. \nVocê confirma o envio?\n\n",
									"Reenviar e-mail",
	...
	// FrameDetalheAll().setVisible(true);}
